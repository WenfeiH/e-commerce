...
<html>
    ...
    <body>
        ...
        if($valRes === TRUE) {
            ...
            $succ = $stmt->execute(array(':orderNumber' => $orderNumber,':productName' => $_GET['productName'],':Name' => $_POST['lastName'].", ".$_POST['firstName'],':email' => $_POST['email'],
        ...
        <?php 
            } else {    // Inserting into database failed
                echo "<h1>Error!</h1>";
                echo "<p>Order submission failed.</p>";
            }

        } else {    // Had bad data or form is incompleted
            echo $valRes;
        }
