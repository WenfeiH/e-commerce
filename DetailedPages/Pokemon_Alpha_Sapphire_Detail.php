...
<html>
    <head>
        <title>Pokemon Fans | Alpha Sapphire</title>
        ...
        <div class="details" >   
            <table class="column">
                <td class="left">
                    <table class="column">
                         <tr>
                             <img class="thumbnail1" src="../Images/Pokemon_Alpha_Sapphire/Pokemon_Alpha_Sapphire.jpeg">
                         </tr>
                         <tr>
                             <td class="columns">
                                 <div>
                                     <img class="thumbnail1" src="../Images/Pokemon_Alpha_Sapphire/Pokemon_Alpha_Sapphire_1.jpg">
                                 </div>
                             </td>
                             <td class="columns">
                                 <div>
                                     <img class="thumbnail1" src="../Images/Pokemon_Alpha_Sapphire/Pokemon_Alpha_Sapphire_2.jpg">
                                 </div>
                             </td>
                             <td class="columns">
                                 <div>
                                     <img class="thumbnail1" src="../Images/Pokemon_Alpha_Sapphire/Pokemon_Alpha_Sapphire_3.jpeg">
                                 </div>
                             </td>
                         </tr>
                     </table>
...
<?php
                ...
                $sql = "SELECT * FROM products WHERE name = 'Pokemon Blue'"; 
